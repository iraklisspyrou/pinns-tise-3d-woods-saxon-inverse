...
def main() -> None:
    ...
    parser.add_argument("--dataset", type=Path, default=Path("schwierz_tableII_experimental_bound_only.npz"))
    parser.add_argument("--output-dir", type=Path, default=Path("schwierz_style_lm_results"))
